#!/usr/bin/env python3
"""
Model Parameter Extractor for SPICE Dataset
Extracts key physical parameters from .pm model files
"""
...
# If you want to use a default models directory, set it here:
MODELS_DIR = "models"  # Update if models/ is moved

def extract_model_params(model_file):
    """
    Extract key physical parameters from SPICE model file
    Returns dictionary with extracted NMOS and PMOS parameters
    """
    ...
    try:
        ...
        # Split into NMOS and PMOS sections
...
def extract_device_params(section, device_type):
    """
    Extract specific parameters from NMOS or PMOS section
    device_type: 'N' for NMOS, 'P' for PMOS
    """
    
    params = {}
    
    # Expanded set of parameters to extract for deep learning
    param_patterns = {
...
def test_extraction():
    """Test parameter extraction on available model files"""
